			...
			<div className="max-w-6xl mx-auto p-6">
				...
				<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="grid md:grid-cols-2 gap-8 mb-12">
					...
					<motion.div
						...
						<Image src={bookImages[book.id % bookImages.length] || "/placeholder.svg"} alt={book.title} fill className="object-cover" />
					</motion.div>
				...
				<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="space-y-8">
					...
					<div className="space-y-6">
						{reviews.map((review) => (
							<motion.div key={review.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="bg-card p-6 rounded-lg">
					...
					{/* Add Review Form */}
					<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6 }} className="bg-card p-6 rounded-lg">
