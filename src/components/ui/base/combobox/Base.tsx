"use client";
import { Command, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList } from "@/components/ui/base";
import { Button, Label, Popover, PopoverContent, PopoverTrigger } from "@/components/ui/base";
import {
  BlocksIcon,
  BrainIcon,
  ChevronDownIcon,
              ...
              <CommandGroup>
                {items.map((item) => (
                  ...
                  >
                    ...
                    <span className="text-muted-foreground text-xs">{item.number.toLocaleString()}</span>
                  </CommandItem>
                ))}
              </CommandGroup>
            </CommandList>
