									...
									<DropdownMenuPortal>
										<DropdownMenuSubContent className="p-0 overflow-hidden border-none">
											<motion.div
												...
												className="p-1 bg-white dark:bg-gray-900"
												layout>
												<DropdownMenuCheckboxItem checked={emailNotifications} onCheckedChange={handleEmailNotificationsChange}>
													<motion.div
														custom={0}
														variants={itemVariants}
														initial="hidden"
												...
												<DropdownMenuCheckboxItem checked={pushNotifications} onCheckedChange={handlePushNotificationsChange}>
													<motion.div
														custom={1}
														variants={itemVariants}
														initial="hidden"
