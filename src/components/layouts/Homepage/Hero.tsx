					...
					<div className="flex flex-col space-y-8">
						<motion.div
							...
							<h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
								...
								<span className="block bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Digital Experience</span>
							</h1>
						</motion.div>
						...
						<motion.p
							...
							Elevate your online presence with our cutting-edge solutions designed to captivate your audience and drive meaningful engagement.
						</motion.p>
