				...
				<div className="flex flex-col lg:flex-row items-center gap-12">
					...
					<motion.div
						...
						<motion.h1
							...
							<span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600">Into Digital Realities</span>
						</motion.h1>
						...
						<motion.p
							...
							Elevate your brand with cutting-edge digital experiences that captivate and convert. Our solutions blend innovation with
							performance.
						</motion.p>
						...
						<motion.div
							...
							<Button variant="outline" size="lg" className="border-white text-white hover:bg-white/10 px-8 py-6 rounded-full">
								Watch Demo
							</Button>
						</motion.div>
					</motion.div>
						...
						<motion.div
							...
							<div className="relative">
								...
								<div className="relative bg-gray-900 rounded-2xl p-2 backdrop-blur-sm border border-white/10">
									<img src="/api/placeholder/600/500" alt="Digital Experience Dashboard" className="rounded-xl shadow-2xl w-full" />
